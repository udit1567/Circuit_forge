...
ESP32_CAM_URL = "http://192.168.1.34"
...
QUALITY_MAP = {
    ord('1'): 3,   # QQVGA, 160x120
    ord('2'): 5,   # QVGA, 320x240
    ord('3'): 6,   # CIF, 400x296
    ord('4'): 8,   # VGA, 640x480
    ord('5'): 9,   # SVGA, 800x600
    ord('6'): 10,  # XGA, 1024x768
    ord('7'): 11,  # SXGA, 1280x1024
    ord('8'): 13,  # UXGA, 1600x1200
}
QUALITY_NAMES = {
    3: "QQVGA (160x120)",
    5: "QVGA (320x240)",
...
current_quality = 10 # Default to VGA
...
def main():
    ...
    while True:
        ...
        put_text_with_shadow(annotated_frame, f"Flash: {flash_status}", (10, 30))
